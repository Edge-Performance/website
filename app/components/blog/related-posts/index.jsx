  ...
  return (
    <section className='hidden sm:flex flex-col items-center justify-center w-full'>
      <div className='flex flex-col justify-start items-start w-auto my-20 mx-80 gap-14'>
        <h2 className="font-medium leading-[60.00px] md:max-w-full max-w-screen-sm text-6xl text-gray_900_02 text-left">
              Latest Posts
        </h2>
        <div className='flex flex-col sm:flex-row items-start justify-start w-full gap-6'>
            {relatedPosts.map((blogPost, index) => (
                <div className="flex flex-col gap-[13px] h-full items-start justify-start w-full" key={index}>
