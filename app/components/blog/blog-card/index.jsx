...
export default function BlogCard({ className, postImage, author, title, publishedDate, description }) {
  const parsedDate = parseISO(publishedDate);
  const date = format(parsedDate, 'dd MMMM yyyy');
  return (
    <div className={`${className} flex flex-col gap-3 h-full items-start justify-start w-full`}>
